...
This is deliberate. In [an interview with NPR](https://www.npr.org/2026/03/06/nx-s1-5737901/dopamine-kids-parenting-screens), Michaeleen Doucleff explains how tech starting in the 2000s began to use “tricks and tools…from the gambling industry” to hijack the dopamine system.
...
We have already seen efforts underway to make generative AI more “engaging”, or even worse, reward them for [generating engaging social content](https://dl.acm.org/doi/10.1145/3711896.3736932)\!

Cultural anthropologist Natasha Dow Schüll [identifies four key features](https://www.tandfonline.com/doi/abs/10.1080/19492901.2012.11728356) that keep people on gambling devices in a state called the “[machine zone](https://press.princeton.edu/books/paperback/9780691278285/addiction-by-design)” or “[dark flow](https://pmc.ncbi.nlm.nih.gov/articles/PMC5846824/)”: **solitude** (can be used alone), **bottomlessness** (infinite scrolling content), **speed** (the tech supplies instant gratification), and **teasing** (giving you almost what you want, but never fully satisfying).
...
Regardless of whether, or maybe especially *because,* generative AI is useful, it is imperative to hold it to a similar standard of scrutiny. Social media was useful too\! It was the platform for parent meetups and mutual-aid drives. But [huge](https://www.reuters.com/business/meta-says-us-states-are-seeking-14-trillion-penalties-august-youth-safety-trial-2026-07-07/) [lawsuits](https://www.nytimes.com/2026/03/25/technology/social-media-trial-verdict.html) against Meta and YouTube allege or find that human reward-hacking, especially of children, is exploitative and illegal.
